...
<!-- Sidebar end=============================================== -->
	...
	<h3>  SHOPPING CART [ <small>3 Item(s) </small>]<a href="product" class="btn btn-large pull-right"><i class="icon-arrow-left"></i> Continue Shopping </a></h3>	
	<hr class="soft"/>
	...
	<a href="product" class="btn btn-large"><i class="icon-arrow-left"></i> Continue Shopping </a>
