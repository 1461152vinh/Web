       ...
       <!-- Left Image-->
        <div class="span5">
          <ul class="thumbnails mainimage">
            <li class="span5">
              <a  rel="position: 'inside' , showTitle: false, adjustX:-4, adjustY:-4" class="thumbnail cloud-zoom" href="{{ url($detail->hinhanh) }}">
                <img style="height:400px;width:300px" src="{{ url($detail->hinhanh) }}" alt="" title="">
              </a>
            </li>
            @foreach($image as $i)
            <li class="span5">
              <a  rel="position: 'inside' , showTitle: false, adjustX:-4, adjustY:-4" class="thumbnail cloud-zoom" href="{{ url($i->hinhanh) }}">
                <img style="height:100px;width:100px" src="{{ url($i->hinhanh) }}" alt="" title="">
              </a>
            </li>
            @endforeach
          </ul>
          <ul class="thumbnails mainimage">
            ...
            <li class="producthtumb">
              <a class="thumbnail" >
                <img   src="{{ url($i->hinhanh) }}" alt="" title="">
              </a>
            </li>
            @endforeach
          </ul>
        ...
        <div class="span7">
          <div class="row">
            <div class="span7">
              <h1 class="productname"><span class="bgnone">{{ $detail->tensp }}</span></h1>
              <div class="productprice">
                <div class="productpageprice">
                  <span class="spiral"></span>{{ number_format($detail->gia)  }}</div>
              </div>
